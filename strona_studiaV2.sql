...
--
-- Host: 127.0.0.1
-- Czas generowania: 31 Sty 2023, 23:08
...
CREATE TABLE `zapytanie` (
  ...
  `mail` text NOT NULL,
  `tresc` text NOT NULL,
  `zalacznik` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Zrzut danych tabeli `zapytanie`
--

INSERT INTO `zapytanie` (`id_zap`, `temat`, `imie`, `nazwisko`, `telefon`, `mail`, `tresc`, `zalacznik`) VALUES
(1, 'termin', 'Rafał', 'Bartoń', '123-456-789', 'rafal@wp.pl', 'Testowa wiadomosc', './wgranePliki/image.jpg');
...
--
ALTER TABLE `zapytanie`
  MODIFY `id_zap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
